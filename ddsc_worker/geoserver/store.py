import ddsc_worker.geoserver.workspace as ws
from ddsc_worker.geoserver.resource import featuretype_from_index, coverage_from_index, \
        wmslayer_from_index
from ddsc_worker.geoserver.support import ResourceInfo, xml_property, key_value_pairs, \
